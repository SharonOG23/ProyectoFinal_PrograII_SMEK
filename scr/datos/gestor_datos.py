# En este .py se crea la clase Gestor de Datos.
...
#----------------------------------------------------------------------------------------------------------------------#
class GestorDatos: #Definicion clase GestorDatos de CSV de la carpeta data-raw
    # Definicion del construcutor
    def __init__(self, ruta_archivo):
        self.__ruta_archivo = ruta_archivo  # Variable que guarda la ruta del archivo
        self.__encabezado = None  # Variable que me guardara los encabezados
...
# Se crean los setter (modificadores).
    @ruta_archivo.setter
